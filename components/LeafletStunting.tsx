...
interface LeafletStuntingProps {
  pdfUrl: string;
  width?: number;
  className?: string;
...
const StuntingDescription: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center px-4">
        {/* KOTAK UTAMA */}
        <div className="bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50 rounded-3xl p-8 lg:p-12 shadow-xl border border-cyan-100 w-full max-w-4xl">
          {/* Content */}
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-800">Tentang Leaflet Stunting</h2>
          </div>
          
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <p className="text-lg lg:text-xl">
              <span className="font-semibold text-cyan-700">Stunting merupakan salah satu tantangan kesehatan terbesar</span> yang dihadapi Indonesia saat ini. 
              Kondisi gagal tumbuh pada anak akibat kekurangan gizi kronis ini tidak hanya berdampak pada tinggi badan yang pendek, 
              tetapi juga mempengaruhi perkembangan kognitif dan kecerdasan anak. Leaflet edukasi ini hadir sebagai panduan komprehensif 
              untuk memahami apa itu stunting, mengapa stunting dapat terjadi, serta langkah-langkah pencegahan yang dapat dilakukan 
              oleh setiap keluarga dan masyarakat.
            </p>
            
            <p className="text-lg lg:text-xl">
              <span className="font-semibold text-cyan-700">Melalui pendekatan ABCDE (Aktif minum Tablet Tambah Darah, Bumil rutin periksa kehamilan, Cukupi konsumsi protein hewani, Datang ke Posyandu tiap bulan, dan Eksklusif ASI 6 bulan)</span>, 
              leaflet ini memberikan panduan praktis yang mudah diingat dan diterapkan dalam kehidupan sehari-hari. 
              Dengan fokus pada 1000 Hari Pertama Kehidupan sebagai periode emas perkembangan anak, informasi dalam leaflet ini 
              menekankan pentingnya gizi seimbang, pola asuh yang tepat, dan akses layanan kesehatan yang memadai. 
              Mari bersama-sama wujudkan generasi Indonesia yang sehat, cerdas, dan bebas stunting untuk masa depan bangsa yang lebih cerah.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-white rounded-2xl shadow-md border-l-4 border-cyan-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 italic">"Cegah Stunting, Cerdaskan Generasi! Tumbuh Sehat, Tumbuh Hebat!"</p>
              </div>
            </div>
          </div>
        </div>
...
// Komponen halaman leaflet stunting
const StuntingPage = forwardRef<HTMLDivElement, StuntingPageProps>(({ pageNumber, width, pdfUrl }, ref) => {
  ...
  return (
    <div 
      ...
      className={`stunting-page group transition-all duration-700 mx-auto ${
    ...
    >
      {!isLoaded && !error && isPageVisible && (
        <div className="flex flex-col justify-center items-center h-full text-cyan-600 gap-4 animate-pulse">
          <div className="relative">
            <div className="w-10 h-10 border-3 border-cyan-200 border-t-cyan-600 rounded-full animate-spin"></div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-cyan-600 rounded-full animate-pulse"></div>
          </div>
      ...
      <div className={`absolute bottom-4 right-4 bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-3 py-1.5 rounded-full text-xs font-semibold shadow-lg transition-all duration-300 ${
      ...
      {/* Hover overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-cyan-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-xl pointer-events-none" />
    </div>
  );
});

StuntingPage.displayName = 'StuntingPage';

const LeafletStunting: React.FC<LeafletStuntingProps> = ({
  pdfUrl,
  width = 800, // Not used anymore, just keep for interface
  className = '',
  ...
  const handleDownload = useCallback(() => {
    ...
    link.href = pdfUrl;
    link.download = 'Leaflet-Stunting.pdf';
    link.target = '_blank';
    ...
    <div className={`w-full ${className}`}>
      {isLoading && (
        <div className="flex justify-center items-center min-h-[400px] px-4">
          <div className="card bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50 text-center max-w-2xl mx-auto animate-fade-in">
            ...
            <h3 className="text-2xl font-bold text-cyan-800 mb-4">Memuat Leaflet Stunting</h3>
            <p className="text-cyan-600 mb-6">Menyiapkan konten edukasi pencegahan stunting...</p>
            <div className="w-64 h-2 bg-cyan-200 rounded-full overflow-hidden mx-auto">
      ...
      {!isLoading && numPages > 0 && (
        <div className="w-full max-w-5xl mx-auto px-4 -mt-60">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-3 rounded-full text-sm font-semibold shadow-lg mb-2 animate-fade-in-delay">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
              <span>Materi Edukasi Kesehatan</span>
            </div>
            ...
            <p className="section-description mx-auto text-center">
              Panduan lengkap untuk memahami dan mencegah stunting pada anak. 
              Material edukasi ini berisi informasi penting tentang gizi, pola asuh, dan langkah pencegahan stunting.
            </p>
          ...
          {/* Description Section */}
          {showDescription && <StuntingDescription />}
            ...
            <div className="max-w-md mx-auto">
              ...
              >
                <span className="flex items-center justify-center gap-3">
                  ...
                  <span>Unduh Leaflet Stunting</span>
                </span>
              </button>
            </div>
          </div>
      ...
      <style jsx>{`
        ...
        .stunting-pages-container {
          width: 100%;
        }

        /* Enhanced mobile optimizations */
        @media (max-width: 768px) {
          .leaflet-stunting-container {
            padding: 1rem 0;
          }
...
export default LeafletStunting;